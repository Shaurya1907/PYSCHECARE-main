...
const mentalHealthResponses = {
    ...
    // Help response strings (verified proper spacing: "what you're going through")
    ...
    // Bye response strings (verified proper spacing: "taking care of your mental health")
    ...
    // Anxiety response strings (verified proper spacing: "anxiety are extreme")
    ...
    // Insomnia response strings (verified proper spacing: "healthcare provider")
